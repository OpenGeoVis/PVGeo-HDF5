...
Generator().DocumentPackages(pvgeohdf, index_base='../../README.rst', showprivate=True)
...
htmlhelp_basename = 'PVGeo-HDF5doc'
...
latex_documents = [
    (master_doc, 'PVGeo-HDF5.tex', 'PVGeo-HDF5 Documentation',
...
intersphinx_mapping = {'https://docs.python.org/': None,
                       'http://docs.pvgeo.org/en/latest/': None}
